...
class Joystick(Widget):
    ...
    _total_diameter = NumericProperty(OUTLINE_ZERO)
    _total_radius = NumericProperty(OUTLINE_ZERO)

    _inner_diameter = NumericProperty(OUTLINE_ZERO)
    _inner_radius = NumericProperty(OUTLINE_ZERO)

    _outer_diameter = NumericProperty(OUTLINE_ZERO)
    _outer_radius = NumericProperty(OUTLINE_ZERO)

    _magnitude = OUTLINE_ZERO
    ...
    def _radians(self):
        ...
        if self.pad_x > OUTLINE_ZERO and self.pad_y > OUTLINE_ZERO:  # 1st Quadrant
            return arc_tangent
        elif self.pad_x > OUTLINE_ZERO > self.pad_y:  # 4th Quadrant
    ...
    def center_pad(self):
        ...
        self._magnitude = OUTLINE_ZERO
        self.pad_x = OUTLINE_ZERO
        self.pad_y = OUTLINE_ZERO
